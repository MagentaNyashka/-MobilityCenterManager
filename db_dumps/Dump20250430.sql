...
INSERT INTO `orders` VALUES (1,1,1,'2025-04-29 00:00:00','completed'),(2,1,1,'2025-04-28 00:00:00','completed'),(3,1,1,'2025-04-29 20:24:00','completed'),(4,1,1,'2025-04-29 20:24:01','completed');
...
--
-- Dumping routines for database 'mobile_center_db'
--
/*!50003 DROP PROCEDURE IF EXISTS `AddConnection` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddConnection`(
    IN station_from INT,
    IN station_to INT,
    IN travel_time INT
)
BEGIN
    -- Добавляем связь из station_from в station_to
    INSERT IGNORE INTO connections (station_from_id, station_to_id, travel_time)
    VALUES (station_from, station_to, travel_time);

    -- Добавляем обратную связь из station_to в station_from
    INSERT IGNORE INTO connections (station_from_id, station_to_id, travel_time)
    VALUES (station_to, station_from, travel_time);
END ;;
DELIMITER ;
...
-- Dump completed on 2025-04-30  6:04:00
